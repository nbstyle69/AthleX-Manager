  ...
  fr: {
    ...
    tools: {
      ...
      items: [
        ...
        { title: 'Timer', desc: 'AMRAP, EMOM, For Time, Tabata : un chrono de compétition précis à la seconde, avec signaux sonores.' },
        ...
        { title: 'Compétitions récurrentes', desc: 'Des tournois et défis qui reviennent régulièrement pour rester motivé toute l’année.' },
  ...
  en: {
    ...
    tools: {
      ...
      items: [
        ...
        { title: 'Timer', desc: 'AMRAP, EMOM, For Time, Tabata: a competition-grade timer accurate to the second, with audio cues.' },
        ...
        { title: 'Recurring competitions', desc: 'Tournaments and challenges that come back regularly to keep you motivated all year.' },
