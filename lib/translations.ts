...
export const translations = {
  fr: {
    ...
    boxPage: {
      ...
      trial: {
        section: "Séance d'essai",
        subtitle: 'Gratuite, sans créer de compte — choisis un cours à venir et viens tester {box}',
        badge: 'Essai',
        detail: '1 séance découverte · gratuite',
        cta: 'Réserver mon essai',
        formTitle: 'Tes coordonnées',
        formHint: 'Aucun compte à créer. La box a besoin de te reconnaître à ton arrivée.',
        firstName: 'Prénom',
        lastName: 'Nom',
        email: 'E-mail',
        phone: 'Téléphone (optionnel)',
        next: 'Voir les cours',
        slotsTitle: 'Choisis ton créneau',
        slotsHint: 'Seuls les cours à venir ayant encore de la place sont proposés.',
        pickDay: 'Choisis un jour',
        moreDays: 'Voir les dates suivantes',
        horizonAll: 'Toutes les dates ouvertes sont affichées.',
        noSlotsThatDay: 'Plus de place ce jour-là. Choisis un autre jour.',
        loading: 'Chargement…',
        seatsLeft: '{n} place restante',
        seatsLeftPlural: '{n} places restantes',
        noSlots: 'Aucun créneau disponible pour le moment. Reviens dans quelques jours ou contacte la box.',
        confirm: 'Confirmer ma réservation',
        back: 'Retour',
        close: 'Fermer',
        terms: 'Conditions',
        successTitle: "C'est réservé",
        successBody: 'On t’attend pour {title}, {when}.',
        successMail: 'Un e-mail de confirmation vient de partir.',
        successNoMail: "L'e-mail de confirmation n'a pas pu partir : note bien la date.",
        errors: {
          champs_manquants: 'Prénom et e-mail sont nécessaires.',
          prenom_absent: 'Indique ton prénom.',
          email_invalide: 'Cette adresse e-mail ne semble pas valide.',
          box_absente: 'Box introuvable.',
          box_introuvable: "Cette box n'accepte pas de réservation pour le moment.",
          offre_essai_absente: "Cette box ne propose pas de séance d'essai en ligne.",
          creneau_introuvable: "Ce créneau n'existe plus.",
          creneau_passe: 'Ce cours a déjà commencé. Choisis-en un autre.',
          creneau_complet: 'Ce cours vient de se remplir. Choisis un autre créneau.',
          deja_reserve: 'Tu as déjà réservé ce cours avec cette adresse e-mail.',
          plafond_box_atteint: "Tu as déjà utilisé tes séances d'essai dans cette box.",
          plafond_fenetre_atteint: 'Trop de réservations récentes avec cette adresse. Réessaie plus tard.',
          trop_de_tentatives: 'Trop de tentatives depuis cette connexion. Réessaie dans une heure.',
          trop_de_requetes: 'Trop de requêtes depuis cette connexion. Réessaie dans quelques minutes.',
          lecture_impossible: "Le calendrier n'a pas pu être lu. Réessaie dans un instant.",
          reservation_impossible: "La réservation n'a pas pu être enregistrée. Réessaie dans un instant.",
        },
      },
    ...
    funnel: {
      common: {
        ...
        errorTitle: 'L’action n’a pas abouti',
        close: 'Fermer',
      ...
      onboarding: {
        ...
        accountExists: 'Un compte existe déjà avec cet e-mail. Connecte-toi, puis crée ta box depuis ton compte.',
  ...
  en: {
    ...
    boxPage: {
      ...
      trial: {
        section: 'Free trial session',
        subtitle: 'Free, no account needed — pick an upcoming class and come try {box}',
        badge: 'Trial',
        detail: '1 discovery session · free',
        cta: 'Book my trial',
        formTitle: 'Your details',
        formHint: 'No account to create. The box just needs to recognise you when you arrive.',
        firstName: 'First name',
        lastName: 'Last name',
        email: 'Email',
        phone: 'Phone (optional)',
        next: 'See the classes',
        slotsTitle: 'Pick your slot',
        pickDay: 'Pick a day',
        moreDays: 'Show later dates',
        horizonAll: 'All open dates are shown.',
        noSlotsThatDay: 'No seat left that day. Pick another day.',
        slotsHint: 'Only upcoming classes with seats left are offered.',
        loading: 'Loading…',
        seatsLeft: '{n} seat left',
        seatsLeftPlural: '{n} seats left',
        noSlots: 'No slot available right now. Come back in a few days or contact the box.',
        confirm: 'Confirm my booking',
        back: 'Back',
        close: 'Close',
        terms: 'Terms',
        successTitle: 'Booked',
        successBody: 'See you for {title}, {when}.',
        successMail: 'A confirmation email is on its way.',
        successNoMail: 'The confirmation email could not be sent: make a note of the date.',
        errors: {
          champs_manquants: 'First name and email are required.',
          prenom_absent: 'Please enter your first name.',
          email_invalide: 'This email address does not look valid.',
          box_absente: 'Box not found.',
          box_introuvable: 'This box is not taking bookings right now.',
          offre_essai_absente: 'This box does not offer an online trial session.',
          creneau_introuvable: 'This slot no longer exists.',
          creneau_passe: 'This class has already started. Pick another one.',
          creneau_complet: 'This class just filled up. Pick another slot.',
          deja_reserve: 'You already booked this class with this email address.',
          plafond_box_atteint: 'You already used your trial sessions at this box.',
          plafond_fenetre_atteint: 'Too many recent bookings from this address. Try again later.',
          trop_de_tentatives: 'Too many attempts from this connection. Try again in an hour.',
          trop_de_requetes: 'Too many requests from this connection. Try again in a few minutes.',
          lecture_impossible: 'The calendar could not be loaded. Try again in a moment.',
          reservation_impossible: 'The booking could not be saved. Try again in a moment.',
        },
      },
    ...
    funnel: {
      ...
      onboarding: {
        ...
        accountExists: 'An account already exists with this email. Sign in, then create your gym from your account.',
