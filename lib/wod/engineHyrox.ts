...
const MOVES: MoveDef[] = [
  { name: 'Sled Push', type: 'station', equipment: 'Sled Push', rpe: [5, 9], loadKey: 'sledPush', force: true, substitution: 'Wall Sprint / poussée de plaque', scheme: (r) => `${r.pick([25, 50])}m` },
  { name: 'Sled Pull', type: 'station', equipment: 'Sled Pull', rpe: [5, 9], loadKey: 'sledPull', force: true, substitution: "Corde fixe / traction d'objet", scheme: (r) => `${r.pick([25, 50])}m` },
  { name: 'Farmers Carry', type: 'station', equipment: 'Farmers Carry', rpe: [5, 8], loadKey: 'farmers', force: true, substitution: 'Tout objet lesté porté', scheme: (r) => `${r.pick([100, 200])}m` },
  { name: 'Sandbag Lunge', type: 'station', equipment: 'Sandbag Lunge', rpe: [5, 8], loadKey: 'sandbag', substitution: 'KB/DB lunge ou gilet', scheme: (r) => `${r.pick([50, 100])}m` },
  { name: 'Wall Balls', type: 'station', equipment: 'Wall Balls', rpe: [6, 9], loadKey: 'wallBall', substitution: 'Thrusters KB/DB', scheme: (r, d) => `${repScale(d, r.pick([15, 20, 25]))} reps` },
  { name: 'Burpee Broad Jump', type: 'bodyweight', equipment: null, rpe: [5, 9], loadKey: null, substitution: null, scheme: (r) => `${r.pick([20, 40, 80])}m` },
  { name: 'Run', type: 'cardio', equipment: null, rpe: [5, 9], loadKey: null, substitution: 'Row / Bike / Ski (temps équivalent)', scheme: (r) => `${r.pick([200, 400, 800, 1000])}m` },
  { name: 'Row', type: 'cardio', equipment: 'RowErg', rpe: [5, 9], loadKey: null, substitution: 'Ski / Bike', scheme: (r) => `${r.pick([250, 500, 1000])}m` },
  { name: 'SkiErg', type: 'cardio', equipment: 'SkiErg', rpe: [5, 9], loadKey: null, substitution: 'Row / Bike', scheme: (r) => `${r.pick([250, 500, 1000])}m` },
  { name: 'BikeErg', type: 'cardio', equipment: 'BikeErg', rpe: [5, 9], loadKey: null, substitution: 'Row / Ski', scheme: (r) => `${r.pick([10, 15, 20, 30])} cal` },
  { name: 'Shuttle Run', type: 'cardio', equipment: null, rpe: [5, 9], loadKey: null, substitution: 'Navette 10m / sprints courts', scheme: (r) => `${r.pick([8, 10, 12])}×10m` },
  { name: 'Sandbag Thruster', type: 'sandbag', equipment: 'Sandbag', rpe: [6, 9], loadKey: 'sandbagLoad', substitution: 'DB/KB thruster', scheme: (r, d) => `${repScale(d, r.pick([10, 15]))} reps` },
  { name: 'Sandbag Front Rack Squat', type: 'sandbag', equipment: 'Sandbag', rpe: [6, 8], loadKey: 'sandbagLoad', substitution: 'Goblet squat', scheme: (r, d) => `${repScale(d, r.pick([10, 15, 20]))} reps` },
  { name: 'Sandbag S2OH', type: 'sandbag', equipment: 'Sandbag', rpe: [6, 9], loadKey: 'sandbagLoad', substitution: 'DB push press', scheme: (r, d) => `${repScale(d, r.pick([8, 12, 15]))} reps` },
  { name: 'Sandbag Bent Over Row', type: 'sandbag', equipment: 'Sandbag', rpe: [6, 8], loadKey: 'sandbagLoad', substitution: 'DB row', scheme: (r, d) => `${repScale(d, r.pick([10, 15]))} reps` },
  { name: 'Sandbag Over-the-Shoulder', type: 'sandbag', equipment: 'Sandbag', rpe: [7, 9], loadKey: 'sandbagLoad', substitution: 'DB clean', scheme: (r, d) => `${repScale(d, r.pick([8, 12]))} reps` },
  { name: 'KB Swing', type: 'kb', equipment: 'Kettlebell', rpe: [6, 9], loadKey: 'kb', substitution: 'DB swing', scheme: (r, d) => `${repScale(d, r.pick([15, 20, 25]))} reps` },
  { name: 'Goblet Squat', type: 'kb', equipment: 'Kettlebell', rpe: [5, 8], loadKey: 'kb', force: true, substitution: 'Air squat lesté', scheme: (r, d) => `${repScale(d, r.pick([15, 20]))} reps` },
  { name: 'KB Deadlift', type: 'kb', equipment: 'Kettlebell', rpe: [5, 8], loadKey: 'kb', force: true, substitution: 'DB deadlift', scheme: (r, d) => `${repScale(d, r.pick([10, 15, 20]))} reps` },
  { name: 'DB Push Press', type: 'kb', equipment: 'Haltères', rpe: [6, 9], loadKey: 'kb', force: true, substitution: 'KB push press', scheme: (r, d) => `${repScale(d, r.pick([10, 15]))} reps` },
  { name: 'Alt DB Snatch', type: 'kb', equipment: 'Haltères', rpe: [7, 9], loadKey: 'kb', substitution: 'KB snatch', scheme: (r, d) => `${repScale(d, r.pick([10, 20, 30]))} reps` },
  { name: 'Burpee', type: 'bodyweight', equipment: null, rpe: [5, 9], loadKey: null, substitution: null, scheme: (r, d) => `${repScale(d, r.pick([10, 15, 20]))} reps` },
  { name: 'Burpee over Target', type: 'bodyweight', equipment: null, rpe: [6, 9], loadKey: null, substitution: 'Burpee simple', scheme: (r, d) => `${repScale(d, r.pick([10, 15]))} reps` },
  { name: 'Walking Lunge', type: 'bodyweight', equipment: null, rpe: [5, 8], loadKey: null, substitution: 'Fentes alternées sur place', scheme: (r) => `${r.pick([50, 100, 200])}m` },
  { name: 'Mountain Climbers', type: 'bodyweight', equipment: null, rpe: [5, 8], loadKey: null, substitution: null, scheme: (r, d) => `${repScale(d, r.pick([30, 40, 50]))} reps` },
  { name: 'Bear Crawl', type: 'bodyweight', equipment: null, rpe: [5, 8], loadKey: null, substitution: null, scheme: (r) => `${r.pick([15, 20, 30])}m` },
  { name: 'Broad Jump', type: 'bodyweight', equipment: null, rpe: [5, 8], loadKey: null, substitution: null, scheme: (r, d) => `${repScale(d, r.pick([10, 15]))} reps` },
  { name: 'Jumping Jacks', type: 'bodyweight', equipment: null, rpe: [5, 7], loadKey: null, substitution: null, scheme: (r, d) => `${repScale(d, r.pick([40, 50]))} reps` },
  { name: 'Push-up (HR)', type: 'bodyweight', equipment: null, rpe: [5, 8], loadKey: null, substitution: null, scheme: (r, d) => `${repScale(d, r.pick([10, 15, 20]))} reps` },
  { name: 'Air Squat', type: 'bodyweight', equipment: null, rpe: [5, 7], loadKey: null, substitution: null, scheme: (r, d) => `${repScale(d, r.pick([20, 25, 30]))} reps` },
  { name: 'Sit-up', type: 'bodyweight', equipment: null, rpe: [5, 7], loadKey: null, substitution: null, scheme: (r, d) => `${repScale(d, r.pick([15, 20]))} reps` },
  { name: 'Pistol Squat', type: 'bodyweight', equipment: null, rpe: [6, 8], loadKey: null, force: true, substitution: 'Squat sur boîte / assisté', scheme: (r, d) => `${repScale(d, r.pick([8, 10]))} reps (alt.)` },
  { name: 'Bulgarian Split Squat', type: 'bodyweight', equipment: null, rpe: [6, 8], loadKey: null, force: true, substitution: 'Fentes arrière', scheme: (r, d) => `${repScale(d, r.pick([8, 10]))} reps/jambe` },
  { name: 'Strict HSPU', type: 'bodyweight', equipment: null, rpe: [6, 9], loadKey: null, force: true, substitution: 'Pike push-up / DB strict press', scheme: (r, d) => `${repScale(d, r.pick([5, 8, 10]))} reps` },
  { name: 'Pike Push-up', type: 'bodyweight', equipment: null, rpe: [6, 8], loadKey: null, force: true, substitution: null, scheme: (r, d) => `${repScale(d, r.pick([8, 10, 12]))} reps` },
  { name: 'Diamond Push-up', type: 'bodyweight', equipment: null, rpe: [6, 8], loadKey: null, force: true, substitution: null, scheme: (r, d) => `${repScale(d, r.pick([8, 10, 12]))} reps` },
  { name: 'Single-Leg Glute Bridge', type: 'bodyweight', equipment: null, rpe: [5, 8], loadKey: null, force: true, substitution: null, scheme: (r, d) => `${repScale(d, r.pick([10, 12]))} reps/jambe` },
  { name: 'Tempo Air Squat', type: 'bodyweight', equipment: null, rpe: [5, 8], loadKey: null, force: true, substitution: null, scheme: (r, d) => `${repScale(d, r.pick([10, 15]))} reps (tempo 3s)` },
  { name: 'Nordic Curl', type: 'bodyweight', equipment: null, rpe: [6, 8], loadKey: null, force: true, substitution: 'Good morning / leg curl', scheme: (r, d) => `${repScale(d, r.pick([5, 8]))} reps` },
  { name: 'Strict Pull-up', type: 'bodyweight', equipment: null, rpe: [6, 9], loadKey: null, force: true, substitution: 'Ring rows / tractions assistées', scheme: (r, d) => `${repScale(d, r.pick([5, 8, 10]))} reps` },
  { name: 'KB Romanian Deadlift', type: 'kb', equipment: 'Kettlebell', rpe: [6, 8], loadKey: 'kb', force: true, substitution: 'DB RDL', scheme: (r, d) => `${repScale(d, r.pick([8, 10, 12]))} reps` },
  { name: 'KB Front Rack Squat', type: 'kb', equipment: 'Kettlebell', rpe: [6, 8], loadKey: 'kb', force: true, substitution: 'Goblet squat', scheme: (r, d) => `${repScale(d, r.pick([8, 10]))} reps` },
  { name: 'Single-Arm KB Press', type: 'kb', equipment: 'Kettlebell', rpe: [6, 8], loadKey: 'kb', force: true, substitution: 'DB strict press', scheme: (r, d) => `${repScale(d, r.pick([6, 8, 10]))} reps/bras` },
  { name: 'KB Bent Over Row', type: 'kb', equipment: 'Kettlebell', rpe: [6, 8], loadKey: 'kb', force: true, substitution: 'DB row', scheme: (r, d) => `${repScale(d, r.pick([8, 10, 12]))} reps/bras` },
  { name: 'KB Clean & Press', type: 'kb', equipment: 'Kettlebell', rpe: [6, 9], loadKey: 'kb', force: true, substitution: 'DB clean & press', scheme: (r, d) => `${repScale(d, r.pick([6, 8, 10]))} reps/bras` },
  { name: 'DB Strict Shoulder Press', type: 'kb', equipment: 'Haltères', rpe: [6, 8], loadKey: 'kb', force: true, substitution: 'KB strict press', scheme: (r, d) => `${repScale(d, r.pick([8, 10, 12]))} reps` },
  { name: 'DB Floor Press', type: 'kb', equipment: 'Haltères', rpe: [6, 8], loadKey: 'kb', force: true, substitution: 'Push-up lesté', scheme: (r, d) => `${repScale(d, r.pick([8, 10, 12]))} reps` },
  { name: 'DB Romanian Deadlift', type: 'kb', equipment: 'Haltères', rpe: [6, 8], loadKey: 'kb', force: true, substitution: 'KB RDL', scheme: (r, d) => `${repScale(d, r.pick([8, 10, 12]))} reps` },
  { name: 'DB Bent Over Row', type: 'kb', equipment: 'Haltères', rpe: [6, 8], loadKey: 'kb', force: true, substitution: 'KB row', scheme: (r, d) => `${repScale(d, r.pick([8, 10, 12]))} reps/bras` },
  { name: 'Renegade Row', type: 'kb', equipment: 'Haltères', rpe: [6, 9], loadKey: 'kb', force: true, substitution: 'DB row à genoux', scheme: (r, d) => `${repScale(d, r.pick([6, 8, 10]))} reps/bras` },
  { name: 'DB Walking Lunge (lourd)', type: 'kb', equipment: 'Haltères', rpe: [6, 8], loadKey: 'kb', force: true, substitution: 'Goblet lunge', scheme: (r, d) => `${repScale(d, r.pick([8, 10]))} reps/jambe` },
  { name: 'DB Thruster', type: 'kb', equipment: 'Haltères', rpe: [6, 9], loadKey: 'kb', force: true, substitution: 'KB thruster', scheme: (r, d) => `${repScale(d, r.pick([8, 10, 12]))} reps` },
];
