...
export async function middleware(request: NextRequest) {
  ...
  if (pathname.startsWith('/api/') || pathname.startsWith('/test-login') || pathname.startsWith('/landing') || pathname.startsWith('/signup') || pathname.startsWith('/classement') || pathname.startsWith('/privacy') || pathname === '/box' || pathname.startsWith('/box/') || pathname.startsWith('/pricing') || pathname.startsWith('/.well-known')) {
