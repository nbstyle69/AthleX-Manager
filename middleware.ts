...
export async function middleware(request: NextRequest) {
  ...
  if (pathname.startsWith('/api/') || pathname.startsWith('/landing') || pathname.startsWith('/signup') || pathname.startsWith('/reset-password') || pathname.startsWith('/update-password') || pathname.startsWith('/email-confirme') || pathname.startsWith('/rejoindre/') || pathname.startsWith('/classement') || pathname.startsWith('/privacy') || pathname === '/box' || pathname.startsWith('/box/') || pathname.startsWith('/pricing') || pathname.startsWith('/.well-known')) {
