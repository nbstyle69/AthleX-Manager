...
/**
 * Les deux onglets marchands de Marketplace. L'onglet vient de la route
 * (`/programming`, `/programming/offers`) et non d'un état local : une offre
 * s'envoie par lien, et le bouton « ? » ouvre les tutoriels de l'onglet ouvert.
 */
export default function MarketplaceWorkspace({ tab }: { tab: 'catalogue' | 'mine' }) {
