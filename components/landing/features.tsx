...
import { Users, Megaphone, CalendarClock, ClipboardList, Trophy, MessageSquare, type LucideIcon } from 'lucide-react';
import { useLanguage } from '@/components/language-provider';

const ICONS: LucideIcon[] = [Users, Megaphone, CalendarClock, ClipboardList, Trophy, MessageSquare];
