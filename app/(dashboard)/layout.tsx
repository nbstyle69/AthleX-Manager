...
export default async function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  // Aucune box administrée = un adhérent, pas un gérant mal configuré. Le
  // cul-de-sac « Box non configurée » lui annonçait une panne de sa box alors
  // qu'il n'en gère aucune : il part chez lui. `getAdminBoxes` lève sur panne
